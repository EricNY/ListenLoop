...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { body: @slide.body, presentation_id: @slide.presentation_id, title: @slide.title }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { body: @slide.body, presentation_id: @slide.presentation_id, title: @slide.title }
    assert_redirected_to slide_path(assigns(:slide))
  end
